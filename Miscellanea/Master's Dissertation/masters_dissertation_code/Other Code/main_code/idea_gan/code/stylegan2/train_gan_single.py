...
from model_single import Generator, Discriminator
from dataset_single import MultiResolutionDataset
...
if(__name__ == "__main__"):
    ...
    parser.add_argument(
        "--batch", type=int, default=12, help="batch sizes for each gpus"
    )
    parser.add_argument(
        "--n_sample",
        type=int,
    ...
    if args.ckpt is not None:
        ...
        save_dir = "outputs/" + timestamp + "_stylegan2"
    ...
    '''
    COMMANDS:
    (prepare the dataset) python3 prepare_data.py --out ./outputs/dataset/dataset.lmdb --n_worker 1 --size 128 ../../dataset/data/train/0/
    (train the network) python3 train_gan.py ./outputs/dataset/dataset.lmdb/
    '''