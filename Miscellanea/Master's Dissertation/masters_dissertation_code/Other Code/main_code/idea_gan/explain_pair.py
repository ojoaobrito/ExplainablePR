...
CNN_PATH = "outputs/densenet_161/models/densenet_161.pt"
...
K_NEIGHBOURS = 100 if(len(sys.argv) != 6) else int(sys.argv[1])
...
CNN_SIDE_PATH = "outputs/resnet_18/models/resnet_18.pt"
...
if(__name__ == "__main__"):
    ...
    if(genuine_or_impostor == "I" and USE_SEGMENTATION_DATA):
        ...
        # we can use the previously computed masks
            ...
            masks = list(filter(lambda x : (x[0] != ".") and (x != "1.jpg") and (x != "2.jpg"), os.listdir("performance_evaluation_pairs/" + pair_name)))

            for i in masks:
                copyfile("performance_evaluation_pairs/" + pair_name + "/" + i, "test_pair_masks/" + i)
    ...
    # if they were inverted, put the images back in the original order
    ...
    with open("times_our.txt", "a") as file:
